...
STATICFILES_DIRS = [
    ...
    ('ol-ext', BASE_DIR / "node_modules/ol-ext/dist"),
    ('bc-sans', BASE_DIR / "node_modules/@bcgov/bc-sans"),
]
...
SECRET_KEY = env('SECRET_KEY', 'django-insecure-0lgov2k26n+=bjocstuna-@888$&g3(xvxugltqd*xx+z=_p1=')
