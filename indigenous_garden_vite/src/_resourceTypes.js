...
export const ContentBlockResourceTypes = Object.freeze({
  ...
  multilingualLabels: 'ContentBlockMultilingualLabels',
})

export const MultilingualLabelLanguages = Object.freeze({
  english: 'english',
  westernScientific: 'western_scientific',
