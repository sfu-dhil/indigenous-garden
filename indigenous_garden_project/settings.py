"""
Django settings for indigenous_garden_project project.
...
ROOT_URLCONF = 'indigenous_garden_project.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'indigenous_garden_app.context_processors.get_git_info',
            ],
        },
    },
]

WSGI_APPLICATION = 'indigenous_garden_project.wsgi.application'
...
GIT_REPO = 'https://github.com/sfu-dhil/indigenous-garden'
    ...
    'keys': {
        'feature_type': {
            ...
            'choices': [
                ...
                {'title': 'Garden Feature', 'value': 'garden_feature'},
            ],
            'default': 'plant',
            'required': True,
        },
...
DH_MAP_CI_INFO_PAGE_PROPERTIES_SCHEMA = {
    'type': 'dict',
    'keys': {
        'list_icon': {
            'title': 'List Icon (Bootstrap/Fontawesome Icon Classes)',
            'type': 'string',
        },
    }
}